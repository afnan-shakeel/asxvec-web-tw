...
<template>
    <div class="px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Connect Me!</h2>
        <p class="mt-2 text-lg leading-8 text-gray-600">Fill out the details and I'll get back to you shortly.</p>
      </div>
