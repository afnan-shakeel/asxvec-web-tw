                                ...
                                <form>
                                    ...
                                    <div class="mt-6 flex items-center justify-end gap-x-6">
                                        ...
                                        <button type="button" @click="submit()"
                                            ...
                                            Save
                                            <div v-if="submitLoader" role="status">
                                                <svg aria-hidden="true" class="w-4 h-5 mx-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
